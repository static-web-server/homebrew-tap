...
class StaticWebServer < Formula
  ...
  url 'https://github.com/static-web-server/static-web-server/archive/v2.31.1.tar.gz'
  sha256 '63cae6bd2bce4d36907805ea54a1e40e9af93a9fb72accbce6445589a083febc'
