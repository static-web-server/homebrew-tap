...
class StaticWebServer < Formula
  ...
  url 'https://github.com/static-web-server/static-web-server/archive/v2.30.0.tar.gz'
  sha256 'c141d2d9db0d2bc0718bf860558aab0afc2dca0dc0cdedb70f8e01fcb3f867b8'
